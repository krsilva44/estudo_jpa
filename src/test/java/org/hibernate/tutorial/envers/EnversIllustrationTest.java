...
import org.hibernate.tutorial.envers.model.tipo1.Editora1;
import org.hibernate.tutorial.envers.model.tipo1.Event;
import org.hibernate.tutorial.envers.model.tipo2.Cpf;
import org.hibernate.tutorial.envers.model.tipo2.Endereco;
import org.hibernate.tutorial.envers.model.tipo2.Pessoa;
import org.hibernate.tutorial.envers.model.tipo3.Palestra;
import org.hibernate.tutorial.envers.model.tipo3.Palestrante;
...
public class EnversIllustrationTest extends TestCase {
	...
	public void testBasicUsage() {
		...
		palestrante.setDescricao("kenne");
		palestrante.setPalestras(Arrays.asList(palestra));
		...
		entityManager.getTransaction().begin();
		Editora1 livro1 = entityManager.find( Editora1.class, 1L );
		entityManager.close();
